...
public class MainactivityTest {
    ...
    public void testViewswilldisplaywhenenter(){
        ...
        Assert.assertNotNull(editTextView); Assert.assertNotNull(buttonView);
    ...
    public void TestopenOfSendButtonClick() {
        ...
        final ViewInteraction perform = onView(withId(R.id.passButton9)).perform(click());
        ...
        Assert.assertNull(secondActivity);
