...
public class Movieitem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.movie_lists_toolbar);
        ...
        RecyclerView.Adapter mAdapter = new MyAdapter(movies);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public  class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View v) {
                ...
                mTitle = (TextView) v.findViewById(R.id.Movielist);
                myear = (TextView) v.findViewById(R.id.Movieyear);
